      ...
      <div className="space-y-3">
        ...
        <div className="flex space-x-2">
          {Object.entries({
            ...
            const colors = ["#FEF3C7", "#FDE68A", "#FCD34D", "#F59E0B", "#D97706", "#92400E"];
            ...
            return (
              <div key={age} className="flex-1 text-center">
                <div
                  ...
                  title={`${age}: ${count.toLocaleString()}명 (${percentage.toFixed(1)}%)`}
                />
      ...
      {recommendation && (
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            {recommendation.businessRecommendations.slice(0, 3).map((rec, index) => (
              <div key={rec.type} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-medium text-gray-900">
                      {rec.type.replace(/_/g, ' ').split(' ').map(word => 
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <div className="text-xs text-[#6E62F6] mt-1">
                신뢰도 {recommendation.rentRecommendation.rentalSuccessProbability}%
              </div>
            </div>
          </div>
        </div>
